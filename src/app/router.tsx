...
const Empty = lazyWithRetry(() => import('@/features/misc/pages/EmptyPage'));
...
export const router = createBrowserRouter([
  { path: '/login', element: <LoginRoute /> },
  {
    ...
    children: [
      ...
      { path: '/page1', element: <RouteWithNav element={(nav) => withSuspense(<Empty title="Page 1" onNavigateTab={nav.handleNavigateTab} />)} /> },
      { path: '/page2', element: <RouteWithNav element={(nav) => withSuspense(<Empty title="Page 2" onNavigateTab={nav.handleNavigateTab} />)} /> },
      { path: '/page3', element: <RouteWithNav element={(nav) => withSuspense(<Empty title="Page 3" onNavigateTab={nav.handleNavigateTab} />)} /> },
      { path: '*', element: <Navigate to="/dashboard" replace /> },
    ],
  },
]);
