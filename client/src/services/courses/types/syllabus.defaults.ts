import type { OfficialSyllabusData } from './syllabus.types';
export const OFFICIAL_SYLLABUS_CSPC112: OfficialSyllabusData = {
  ...
  classroomPolicies: [
    'Class attendance and punctuality must be observed in accordance to the Revised Student Code of Discipline, Article 10 ΓÇô Class Attendance.',
...
export function createDefaultSyllabusForCourse(course: {
  ...
  if (normCode === 'CMSC131') {
    ...
    return {
      ...
      references: [
        { citation: 'Flanagan, D. (2024). JavaScript: The Definitive Guide (8th ed.). OΓÇÖReilly Media.', year: '2024' },
        { citation: 'Banks, A., & Porcello, E. (2023). Learning React: Modern Patterns for Developing React Apps (2nd ed.). OΓÇÖReilly.', year: '2023' },
  ...
  if (normCode === 'CMSC150') {
    ...
    return {
      ...
      courseInfo: {
        ...
        description:
          'CMSC 150 ΓÇô Automata Theory & Formal Languages introduces the theoretical foundations of computation. Topics include finite automata, regular languages, regular expressions, context-free grammars, pushdown automata, Turing machines, decidability, and computational complexity.'
      },
      facultyMembers: [
        {
          name: course.instructorName || 'Faculty 1',
  ...
  return {
    ...
    courseInfo: {
      ...
      semester: course.term || '1st Sem AY 2026-2027',
      credit: `${course.credits || 3} units`,
      description: `${course.code} ΓÇô ${course.title}. Official institutional course syllabus under the Department of Computer Science, DMMMSU College of Computer Science.`
    },
    facultyMembers: [
      {
